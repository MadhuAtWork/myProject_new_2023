...
function CrecUpdate() {
    ...
    const getMeetingCenterListURL = '/fetchCrec';
        ...
        await fetch(baseURL + fetchMeetingCenterURL, requestOptionscrecbulk)
            ...
            .then((response) => {
                ...
                if (Object.keys(response).length === 0) {
                    alert("No Meeting Center is Available for CREC Update")
                }
                setSelected([]);
    ...
    const onHandleCrecBulkUpdate = async (event) => {
        ...
        if (mcselect === mcTarget) {
            alert("You can not transfer CREC Name to same CREC Name .")
            handleClose()
            return;
        }
        ...
        if (mcTarget == "") {
            alert("Please select New CREC Name  ")
            handleClose()
            return;
        }
        var finalListStr = "";
            ...
            <form onSubmit={onHandleCrecBulkUpdate}>
                <div className='CrecUpdate'>
                    <div className='searchBox mt-4'>
                        <div className="card">
                            <div className="card-header">CREC Update</div>
                            <div className="card-body py-">
                                <div className=' d-flex mb-3'>
                                    <div className='col-11 me-1'>
                                        <Form.Label >CREC Name</Form.Label>
                                ...
                                <div className='mb-3 d-flex'>
                                    ...
                                    <div className='col-11 me-1'>
                                        <Form.Label >New CREC Name</Form.Label>
                                        <Form.Select aria-label="Default select example"
                                            fullWidth
                            ...
                            <Paper sx={{ width: '100%' }}>
                                ...
                                <div className='d-flex justify-content-end p-3' >
                                    ...
                                    <div className='d-flex align-items-center p-1'>
                                        <Button type="button" className='bg-orenge ms-3' variant="contained" onClick={onHandleMigrateCancel}>
                                            Cancel
                                        </Button>
                                    </div>
                                </div>
